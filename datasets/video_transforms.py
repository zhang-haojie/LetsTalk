...
def resize_scale(clip, target_size, interpolation_mode):
    ...
    new_H = int(round(H * scale_))
    new_W = int(round(W * scale_))    
    return torch.nn.functional.interpolate(clip, size=(new_H, new_W), mode=interpolation_mode, align_corners=False)
