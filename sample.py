...
def main(args):
    ...
    for ref_image_path in ref_image_paths:
        ...
        for t in tqdm(range(times), desc="Processing"):
            ...
            z = torch.randn(1, args.clip_frames, args.in_channels, latent_size, latent_size, device=device)
            model_kwargs = dict(y=None, cond=ref_latents, audio_embed=audio_tensor)
